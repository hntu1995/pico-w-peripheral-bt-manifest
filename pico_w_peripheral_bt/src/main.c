/* main.c – Bluetooth GATT Peripheral for Raspberry Pi Pico W
 *
 * Based on zephyr/samples/bluetooth/peripheral.
 * BT transport: Infineon CYW43439 over PIO-SPI (beechwoods cyw43 driver).
 *
...
/* --------------------------------------------------------------------------
 * IAS (Immediate Alert Service) callbacks
 * -------------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------------
 * BT ready – load settings, start advertising
 * -------------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------------
 * Battery level simulation (counts down, wraps at 100 %)
 * -------------------------------------------------------------------------- */
...
int main(void)
{
	...
	printk("Pico W BLE Peripheral starting\n");
	...
	while (1) {
		...
		/* Send CTS notification when a client has subscribed */
